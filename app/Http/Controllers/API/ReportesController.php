...
class ReportesController extends Controller
{
    ...
    public function kpis(Request $request)
    {
        ...
        // ✅ PostgreSQL: EXTRACT(DAY FROM ...) en lugar de DATEDIFF
    ...
    // ══════════════════════════════════════════════
    //  GET /api/reportes/empenos?inicio=&fin=
    ...
    public function empenos(Request $request)
    {
        ...
        // ✅ Tiempo promedio de recuperación (rescatados) - PostgreSQL
        ...
        // ✅ Tendencia mensual (últimos 6 meses) - PostgreSQL
